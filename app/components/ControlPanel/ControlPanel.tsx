    ...
    <section className="controls-panel sticky top-[68px] z-1">
      ...
      <div className="controls-row">
        <div className="input-group" style={{ width: "240px" }}>
          ...
          <input type="text" className="form-input" placeholder="Agregar por UPC o SKU..." style={{ width: "100%" }}/>
        </div>
        ...
        <div className="input-group" style={{ width: "220px" }}>
          ...
          <input type="text" className="form-input" placeholder="Buscar en la lista..." style={{ width: "100%" }}/>
        </div>
        ...
        <select className="form-select" style={{ width: "180px" }}>
          ...
          <option value="low">Bajo stock (&lt; 25%)</option>
          <option value="medium">Stock medio (25-75%)</option>
          <option value="high">Alto stock (&gt; 75%)</option>
        </select>

        <select className="form-select" style={{ width: "180px" }}>
          <option value="">Ordenar por...</option>
          <option value="pct-asc">% restante ↑</option>
          <option value="pct-desc">% restante ↓</option>
          <option value="bin-asc">Ubicación A→Z</option>
          <option value="bin-desc">Ubicación Z→A</option>
        </select>
      </div>
        ...
        <div className="list-name-input" id="listNameInput">
          <div className="input-group" style={{ width: "220px" }}>
            <span className="input-icon">
              ...
              <input type="text" className="form-input" placeholder="Nombre de la lista..." style={{ width: "100%" }}/>
          </div>
        </div>
      </div>
    </section>
